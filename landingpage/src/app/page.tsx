...
import { Moon, Sun, Rocket, Zap, Target, ChevronRight, Percent, CheckCircle, Menu, Play, Pause } from 'lucide-react'
  ...
  return (
    <div id="home" className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} transition-colors duration-300`}>
      ...
      <motion.section
        id="features"
        ref={ref}
        className="container mx-auto px-4 py-12" // Reduced padding
        variants={staggerChildren}
        initial="hidden"
        animate={inView ? "visible" : "hidden"}
      >
        <h2 className={`text-3xl md:text-4xl font-bold mb-8 text-center ${darkMode ? 'text-indigo-300' : 'text-indigo-900'}`}>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <Button className={`${darkMode ? 'bg-indigo-500 hover:bg-indigo-600' : 'bg-indigo-600 hover:bg-indigo-700'} text-white`} onClick={clickPopup}>
                Get Your Score
              </Button>
            </motion.div>
          </motion.div>
